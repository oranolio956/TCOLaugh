...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KDDockWidgets__WidgetResizeHandler_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KDDockWidgets__WidgetResizeHandler_t qt_meta_stringdata_KDDockWidgets__WidgetResizeHandler = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_KDDockWidgets__WidgetResizeHandler[] = {
...
Q_CONSTINIT const QMetaObject KDDockWidgets::WidgetResizeHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_KDDockWidgets__WidgetResizeHandler.offsetsAndSizes,
    qt_meta_data_KDDockWidgets__WidgetResizeHandler,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KDDockWidgets__WidgetResizeHandler_t,
        // Q_OBJECT / Q_GADGET
