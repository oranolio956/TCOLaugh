...
namespace {
struct qt_meta_stringdata_KDDockWidgets__Core__TabBar_t {
    uint offsetsAndSizes[2];
    char stringdata0[28];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KDDockWidgets__Core__TabBar_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KDDockWidgets__Core__TabBar_t qt_meta_stringdata_KDDockWidgets__Core__TabBar = {
    {
        QT_MOC_LITERAL(0, 27)   // "KDDockWidgets::Core::TabBar"
    },
...
Q_CONSTINIT static const uint qt_meta_data_KDDockWidgets__Core__TabBar[] = {
...
Q_CONSTINIT const QMetaObject KDDockWidgets::Core::TabBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_KDDockWidgets__Core__TabBar.offsetsAndSizes,
    qt_meta_data_KDDockWidgets__Core__TabBar,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KDDockWidgets__Core__TabBar_t,
        // Q_OBJECT / Q_GADGET
...
void *KDDockWidgets::Core::TabBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDDockWidgets__Core__TabBar.stringdata0))
