...
namespace {
struct qt_meta_stringdata_KDDockWidgets__Core__Layout_t {
    uint offsetsAndSizes[2];
    char stringdata0[28];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KDDockWidgets__Core__Layout_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KDDockWidgets__Core__Layout_t qt_meta_stringdata_KDDockWidgets__Core__Layout = {
    {
        QT_MOC_LITERAL(0, 27)   // "KDDockWidgets::Core::Layout"
    },
...
Q_CONSTINIT static const uint qt_meta_data_KDDockWidgets__Core__Layout[] = {
...
Q_CONSTINIT const QMetaObject KDDockWidgets::Core::Layout::staticMetaObject = { {
    ...
    qt_meta_stringdata_KDDockWidgets__Core__Layout.offsetsAndSizes,
    qt_meta_data_KDDockWidgets__Core__Layout,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KDDockWidgets__Core__Layout_t,
        // Q_OBJECT / Q_GADGET
...
void *KDDockWidgets::Core::Layout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDDockWidgets__Core__Layout.stringdata0))
