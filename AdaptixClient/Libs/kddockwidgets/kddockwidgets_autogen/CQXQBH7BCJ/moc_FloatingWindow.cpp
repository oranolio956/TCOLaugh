...
namespace {
struct qt_meta_stringdata_KDDockWidgets__QtWidgets__FloatingWindow_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KDDockWidgets__QtWidgets__FloatingWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KDDockWidgets__QtWidgets__FloatingWindow_t qt_meta_stringdata_KDDockWidgets__QtWidgets__FloatingWindow = {
    {
        QT_MOC_LITERAL(0, 40),  // "KDDockWidgets::QtWidgets::Flo..."
        QT_MOC_LITERAL(41, 16),  // "numGroupsChanged"
        QT_MOC_LITERAL(58, 0)   // ""
    },
...
Q_CONSTINIT static const uint qt_meta_data_KDDockWidgets__QtWidgets__FloatingWindow[] = {
...
Q_CONSTINIT const QMetaObject KDDockWidgets::QtWidgets::FloatingWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_KDDockWidgets__QtWidgets__FloatingWindow.offsetsAndSizes,
    qt_meta_data_KDDockWidgets__QtWidgets__FloatingWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KDDockWidgets__QtWidgets__FloatingWindow_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FloatingWindow, std::true_type>,
        // method 'numGroupsChanged'
...
void KDDockWidgets::QtWidgets::FloatingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &FloatingWindow::numGroupsChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *KDDockWidgets::QtWidgets::FloatingWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDDockWidgets__QtWidgets__FloatingWindow.stringdata0))
