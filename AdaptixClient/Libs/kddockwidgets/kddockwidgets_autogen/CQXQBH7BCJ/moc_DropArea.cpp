...
namespace {
struct qt_meta_stringdata_KDDockWidgets__QtWidgets__DropArea_t {
    uint offsetsAndSizes[2];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KDDockWidgets__QtWidgets__DropArea_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KDDockWidgets__QtWidgets__DropArea_t qt_meta_stringdata_KDDockWidgets__QtWidgets__DropArea = {
    {
        QT_MOC_LITERAL(0, 34)   // "KDDockWidgets::QtWidgets::Dro..."
    },
...
Q_CONSTINIT static const uint qt_meta_data_KDDockWidgets__QtWidgets__DropArea[] = {
...
Q_CONSTINIT const QMetaObject KDDockWidgets::QtWidgets::DropArea::staticMetaObject = { {
    ...
    qt_meta_stringdata_KDDockWidgets__QtWidgets__DropArea.offsetsAndSizes,
    qt_meta_data_KDDockWidgets__QtWidgets__DropArea,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KDDockWidgets__QtWidgets__DropArea_t,
        // Q_OBJECT / Q_GADGET
...
void *KDDockWidgets::QtWidgets::DropArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDDockWidgets__QtWidgets__DropArea.stringdata0))
