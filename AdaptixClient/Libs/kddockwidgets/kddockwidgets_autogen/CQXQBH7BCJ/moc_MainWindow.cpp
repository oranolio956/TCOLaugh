...
namespace {
struct qt_meta_stringdata_KDDockWidgets__QtWidgets__MainWindow_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KDDockWidgets__QtWidgets__MainWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KDDockWidgets__QtWidgets__MainWindow_t qt_meta_stringdata_KDDockWidgets__QtWidgets__MainWindow = {
    {
        QT_MOC_LITERAL(0, 36),  // "KDDockWidgets::QtWidgets::Mai..."
        QT_MOC_LITERAL(37, 17),  // "groupCountChanged"
        QT_MOC_LITERAL(55, 0)   // ""
    },
...
Q_CONSTINIT static const uint qt_meta_data_KDDockWidgets__QtWidgets__MainWindow[] = {
...
Q_CONSTINIT const QMetaObject KDDockWidgets::QtWidgets::MainWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_KDDockWidgets__QtWidgets__MainWindow.offsetsAndSizes,
    qt_meta_data_KDDockWidgets__QtWidgets__MainWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KDDockWidgets__QtWidgets__MainWindow_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MainWindow, std::true_type>,
        // method 'groupCountChanged'
...
void KDDockWidgets::QtWidgets::MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MainWindow::groupCountChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *KDDockWidgets::QtWidgets::MainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDDockWidgets__QtWidgets__MainWindow.stringdata0))
