...
namespace {
struct qt_meta_stringdata_KDDockWidgets__QtWidgets__IndicatorWindow_t {
    uint offsetsAndSizes[2];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KDDockWidgets__QtWidgets__IndicatorWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KDDockWidgets__QtWidgets__IndicatorWindow_t qt_meta_stringdata_KDDockWidgets__QtWidgets__IndicatorWindow = {
    {
        QT_MOC_LITERAL(0, 41)   // "KDDockWidgets::QtWidgets::Ind..."
    },
...
Q_CONSTINIT static const uint qt_meta_data_KDDockWidgets__QtWidgets__IndicatorWindow[] = {
...
Q_CONSTINIT const QMetaObject KDDockWidgets::QtWidgets::IndicatorWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_KDDockWidgets__QtWidgets__IndicatorWindow.offsetsAndSizes,
    qt_meta_data_KDDockWidgets__QtWidgets__IndicatorWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KDDockWidgets__QtWidgets__IndicatorWindow_t,
        // Q_OBJECT / Q_GADGET
...
void *KDDockWidgets::QtWidgets::IndicatorWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDDockWidgets__QtWidgets__IndicatorWindow.stringdata0))
