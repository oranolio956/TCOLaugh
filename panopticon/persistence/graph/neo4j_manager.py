...
class Neo4jManager:
    def __init__(self, uri: str = "bolt://localhost:7687", user: str = "neo4j", password: str = "panopticon_secret"):
        self.driver = None
        try:
    ...
    def add_edge(self, source_uid: str, target_uid: str, rel_type: str, properties: Dict[str, Any] = {}):
        if not self.driver: return
        ...
        """
        with self.driver.session() as session:
            session.run(query, source_uid=source_uid, target_uid=target_uid, props=properties)
