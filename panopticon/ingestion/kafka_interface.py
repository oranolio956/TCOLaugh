...
def persist_record(record: Dict[str, Any]) -> str:
    """
    Persist a raw ingestion record to the Polyglot store and extract graph entities.
    ...
    _extract_entities(doc_id, record)
    return doc_id


def _extract_entities(doc_id: str, record: Dict[str, Any]):
    """
